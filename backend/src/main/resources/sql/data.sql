...
values ('数据结构', '202510001', '01', 4.0, '计算机科学与技术专业核心课程，介绍各种数据结构及其应用'),
       ...
       ('算法设计与分析', '202510001', '01', 3.5, '介绍各种算法设计技术和分析方法，培养学生解决复杂问题的能力'),
       ('数据库系统', '202510002', '01', 4.0, '介绍数据库系统的基本概念、设计原理和实现技术'),
       ('软件工程', '202510001', '01', 3.0, '介绍软件开发的方法、工具和管理技术，培养学生的软件开发能力'),
       ('人工智能导论', '202510002', '01', 3.5, '介绍人工智能的基本概念、理论和应用，包括机器学习、自然语言处理等'),
       ('高等数学', '202510002', '09', 4.0, '介绍微积分、线性代数等数学基础知识，为后续专业课程打下基础'),
       ('大学物理', '202510003', '02', 3.5, '介绍力学、电磁学、光学等物理学基础知识'),
       ('马克思主义基本原理', '202510004', '06', 2.0, '介绍马克思主义的基本原理和方法论'),
       ('法律基础', '202510003', '07', 2.5, '介绍法学基本理论和中国法律体系'),
       ('水利工程学', '202510004', '08', 3.5, '介绍水利工程的基本原理和设计方法'),
       ('公共管理学', '202510005', '10', 3.0, '介绍公共管理的基本理论和实践方法');
...
values (1, '202520001', '202510001', '2025-09-01 10:00:00', 85.5),
       ...
       (7, '202520001', '202510001', '2025-09-05 11:00:00', 87.0),
       (7, '202520003', '202510001', '2025-09-05 11:30:00', 91.5),
       (8, '202520002', '202510002', '2025-09-06 09:00:00', 84.5),
       (8, '202520004', '202510002', '2025-09-06 09:30:00', 79.0),
       (9, '202520005', '202510001', '2025-09-07 14:00:00', 93.0),
       (10, '202520006', '202510002', '2025-09-08 10:00:00', 86.5),
       (11, '202520007', '202510002', '2025-09-09 15:30:00', 81.0),
       (12, '202520008', '202510003', '2025-09-10 13:45:00', 89.5);
...
values ('a1b2c3d4-e5f6-7890-abcd-ef1234567890', '数据结构课件第一章', 1, '202510001', '/resources/data-structure/chapter1.pdf', '2025-08-25 08:30:00'),
       ...
       ('e5f6a7b8-c9d0-1234-efgh-345678901234', '算法设计与分析课件', 7, '202510001', '/resources/algorithm/slides.pdf', '2025-08-29 11:30:00'),
       ('f6a7b8c9-d0e1-2345-fghi-456789012345', '数据库系统实验指导', 8, '202510002', '/resources/database/lab-guide.pdf', '2025-08-30 13:45:00'),
       ('a7b8c9d0-e1f2-3456-ghij-567890123456', '软件工程项目案例', 9, '202510001', '/resources/software-eng/cases.pdf', '2025-08-31 10:00:00'),
       ('b8c9d0e1-f2a3-4567-hijk-678901234567', '人工智能导论课件', 10, '202510002', '/resources/ai/intro.pptx', '2025-09-01 14:15:00');
...
values ('数据结构第一次作业', 1, '202510001', '2025-09-15 23:59:59', '完成教材P25-P30的习题', '/assignments/ds-hw1', NULL),
       ...
       ('算法设计第一次作业', 7, '202510001', '2025-10-05 23:59:59', '分析算法复杂度并优化', '/assignments/algo-hw1', NULL),
       ('数据库系统作业', 8, '202510002', '2025-10-10 23:59:59', '设计一个简单的数据库模式', '/assignments/db-hw1', NULL),
       ('软件工程项目计划', 9, '202510001', '2025-10-15 23:59:59', '制定一个软件项目的开发计划', '/assignments/se-hw1', NULL),
       ('人工智能基础作业', 10, '202510002', '2025-10-20 23:59:59', '实现一个简单的机器学习算法', '/assignments/ai-hw1', NULL),
       ('高等数学作业', 11, '202510002', '2025-10-25 23:59:59', '完成教材P50-P55的习题', '/assignments/math-hw1', NULL),
       ('大学物理实验报告', 12, '202510003', '2025-10-30 23:59:59', '完成力学实验并撰写报告', '/assignments/physics-hw1', NULL);