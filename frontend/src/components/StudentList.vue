...
import type { PaginationParams, StudentInfo } from '../api/types';
...
// run: 手动执行请求的方法
// loading: 请求加载状态
const { run: fetchStudentList, loading } = useRequest(
  userService.getStudentList,
  {
    // 请求成功回调
    onSuccess: data => {
      // 更新学生列表数据
      studentList.value = data.data.records;
      // 更新分页信息
  ...
  <el-container class="main-container">
    ...
    <el-header class="main-header">
      ...
      <div class="tool-bar">
        ...
        <!-- 学生ID筛选 -->
        <el-input v-model="userIdFilter" placeholder="学生ID筛选" clearable style="width: 150px; margin-right: 10px;" />
